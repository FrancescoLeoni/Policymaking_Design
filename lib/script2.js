...
rotateGroup.append('text')
    .attr({
        ...
        'font-weight': 'bold',
        'text-anchor': 'middle',
        'transform': 'rotate(270, 100, ' + svgHeight / 2 + ')'
    })
    .text('Supportive');
...
rotateGroup.append('text')
    .attr({
        ...
        'font-weight': 'bold',
        'text-anchor': 'middle',
        'transform': 'rotate(180, 650, ' + svgHeight / 2 + ')'
...
var posizioneX = [10, 20, 10];
var posizioneY = [10, 10, 20];

rotateGroup.selectAll('.Pubblica_amministrazione')
    .attr({
        'cx': function (d, i) { return posizioneX[i]; },
        'cy': function (d, i) { return posizioneY[i]; },
        'r': 4
    });
